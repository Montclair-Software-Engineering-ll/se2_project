...
if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
	...
	$logout_icon = "<a href = '#'><img class = 'Icon' id = 'UserLogoutIcon' src = 'images/sc_logout.png' alt = 'Logout Icon'/></a>";
...
<html>
	...
	<body>
		...
		<div class = "BoxPanel" id = "HeaderPanel">
			...
			<?php
				if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
					echo "<a href = '#'><img class = 'Icon' id = 'UserLogoutIcon' src = 'images/sc_logout.png' alt = 'Logout Icon'/></a>";
				}
			?>
