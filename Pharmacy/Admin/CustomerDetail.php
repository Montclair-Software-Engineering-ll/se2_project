<?php
    ...
    $query = "SELECT `UID`, `email`, `UName`, `UNumber` FROM `user`";
    ...
    <div class="box bg-img">
        <div class="content">
                ...
                <tbody>
                    <?php
                     while($Sale = mysqli_fetch_array($queryfire)){
                        echo "<tr>";
                        echo "<td>".$Sale['UID']."</td>";
                        echo "<td>".$Sale['UName']."</td>";
                        echo "<td>".$Sale['UNumber']."</td>";
            ...
            <form action="DeleteUser.php" method="post">
                <p class="f-pass">DELETE CUSTOMER ACCOUNT:</p>
                <div class="user-input">
                    ...
                    <p class="new-account">Dont want? <a href="../AdminPanel.htm">GO BACK!</a></p>
                </div>
            </form>
        </div>
    </div>
