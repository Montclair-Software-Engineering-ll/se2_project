...
<form action="Restock.php" method="POST">
               <p>Restock Product:</p>
                  <input type="text" class="login-input" placeholder="Enter ID" id="Term" name="Term" required>
                  <input type="text" class="login-input" placeholder="Enter Stock" id="stock" name="stock" required>
            <button class="login-btn">RESTOCK</button>
            </form>
      </div>
    </div>
</body>
