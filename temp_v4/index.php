...
<html>
	...
	<body>
		...
		<div class = "BoxPanel" id = "HeaderPanel">
			...
			<!-- REQUIRES PHP CODE IMBEDDED HERE FOR LOGIN STATE!! -->
			<a href = "<?php echo $cart_icon_link ?>">
				<img class = "Icon" id = "UserLogoutIcon" src = "images/sc_logout.png" alt = "Logout Icon"/>
			</a>
			<a href = "<?php echo $cart_icon_link ?>">
		...
		<div style = "display: inline-block; vertical-align: top; margin-left: 8%; margin-top: 30px"> 
			...
			<!-- REQUIRES PHP CODE IMBEDDED HERE FOR LOGIN STATE!! -->
			<div class = 'BoxPanel' id = 'MessagePanel'>
				<?php echo $notice; ?>
			</div>
